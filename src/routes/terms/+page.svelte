...
<main>
	<article class="page">
		...
		<div class="page__content">
			...
			<p>
				These terms and conditions applies to the Choppy app (hereby referred to as "Application")
				for mobile devices that was created by Lucas BASTIEN (hereby referred to as "Service
			...
			<div>
				...
				<ul>
					...
					<!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!---->
					<li>
						<a href="https://www.mapbox.com/legal/tos" target="_blank" rel="noopener noreferrer"
							>Mapbox</a
						>
					</li>
					<!----><!----><!---->
					...
					<!----><!----><!----><!---->
					<li><a href="https://supabase.com/terms">Supabase</a></li>
				</ul>
			</div>
			<br />
			<p>
			...
			<br />
			<p>These terms and conditions are effective as of 2024-08-12</p>
			<br /><strong>Contact Us</strong>
			<p>
				If you have any questions or suggestions about the Terms and Conditions, please do not
				hesitate to contact the Service Provider at pilotdevelopper@gmail.com.
			</p>
		</div>
	</article>
</main>
